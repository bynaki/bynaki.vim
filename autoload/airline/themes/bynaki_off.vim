...
let g:airline#themes#bynaki_off#palette.replace = copy(g:airline#themes#dark#palette.insert)
let g:airline#themes#bynaki_off#palette.replace.airline_a = [ s:I2[0]   , '#af0000' , s:I2[2] , 124     , ''     ]
let g:airline#themes#bynaki_off#palette.replace_modified = g:airline#themes#dark#palette.insert_modified
