...
let s:N1   = [ '#080808' , '#3a3a3a' , 000 , 003 ]
let s:N2   = [ '#444444' , '#080808' , 005 , 001 ]
let s:N3   = [ '#262626' , '#000000' , 004 , 000 ]
...
let g:airline#themes#bynaki_off#palette.normal_modified = {
      \ 'airline_c': [ '#262626' , '#000000' , 004     , 000     , ''     ] ,
      \ }


let s:I1 = [ '#1c1c1c' , '#d0d0d0' , 001 , 007  ]
let s:I2 = [ '#444444' , '#080808' , 005 , 001  ]
let s:I3 = [ '#262626' , '#000000' , 004 , 000  ]
...
let g:airline#themes#bynaki_off#palette.replace = copy(g:airline#themes#bynaki_off2#palette.insert)
" let g:airline#themes#bynaki_off#palette.replace.airline_a = [ s:I2[0]   , '#af0000' , s:I2[2] , 124     , ''     ]
let g:airline#themes#bynaki_off#palette.replace_modified = g:airline#themes#bynaki_off2#palette.insert_modified


let s:V1 = [ '#3a3a3a' , '#b2b2b2' , 001 , 005  ]
let s:V2 = [ '#444444' , '#808080' , 005 , 001  ]
let s:V3 = [ '#262626' , '#000080' , 004 , 000  ]
...
let s:IA1 = [ '#4e4e4e' , '#1c1c1c' , 004 , 003 , '' ]
let s:IA2 = [ '#4e4e4e' , '#262626' , 004 , 002 , '' ]
let s:IA3 = [ '#4e4e4e' , '#303030' , 004 , 001 , '' ]
